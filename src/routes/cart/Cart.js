            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='flex flex-wrap py-6'>
                    ...
                    <div className='w-full text-center mt-12'>
                      <HeadingRibbon>
                        ...
                        <div className='bg-brandLightBlue pt-12 pb-8 px-8 rounded-xl mt-[-27px]'>
                          <div className='flex gap-4 justify-center max-w-[800px] mx-auto'>
                            {recs.map((product) => (
                              <div>
                                <img
                    ...
                    <div className='bg-white p-4 w-full sticky bottom-0 left-0 md:hidden'>
                      ...
                      <Button
                        removeIcons={true}
                        className='shadow-md hover:shadow-lg w-full h-[40px] group inline-flex items-center justify-center font-bold text-lg rounded-[30px] bg-white text-brandBlue py-1 px-4 pl-2 transition-all border-[3px] mt-4 border-brandBlue hover:bg-brandBlue hover:text-white hover:scale-105'
                        link='/'>
                          Continue Shopping
                      </Button>
                    </div>
