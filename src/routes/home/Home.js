...
const Home = () => {
  return (
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      ...
      <HomeToyTypes />
      <div className='flex justify-center'>
        <h3 id="offers" className="text-3xl md:text-4xl lg:text-5xl font-bold md:!leading-[1.2] text-transparent text-center mt-5 mb-3 md:mt-12 md:mb-4 drop-shadow-md"><span className='bg-gradient-to-r from-brandBlue via-textBlue to-brandBlue bg-clip-text md:!leading-[1.2] text-transparent textStroke'>Offers</span></h3>
      </div>
      <HomeOffers />
      <HomeTopPicks />
      <div className='flex justify-center'>
        <h3 id="offers" className="text-3xl md:text-4xl lg:text-5xl font-bold md:!leading-[1.2] text-transparent text-center mt-5 mb-4 md:mt-12 md:mb-7 drop-shadow-md"><span className='bg-gradient-to-r from-brandBlue via-textBlue to-brandBlue bg-clip-text md:!leading-[1.2] text-transparent textStroke'>Best Brands</span></h3>
      </div>
      <HomeBrands />
      <HomeHeroCard />
      <HomeBlogs />
