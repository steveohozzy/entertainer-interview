            ...
            <div className="bg-brandMediumGreen p-4">
                <div className="max-w-7xl mx-auto px-4 pr-0 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-center text-center mb-4">
                        ...
                        <a href="http://facebook.com" target="_blank" rel="noreferrer" className="ml-1 transition-all hover:rotate-[20deg]">
                        ...
                        <a href="http://tiktok.com" target="_blank" rel="noreferrer" className="ml-1">
                            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-1 transition-all hover:rotate-[20deg]">
