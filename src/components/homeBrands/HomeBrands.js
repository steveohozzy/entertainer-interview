...
const HomeBrands = () => {
  ...
  return (
    <div id="brands" className="flex gap-2 mt-2">
        <button className=" rounded-xl overflow-hidden transition-all hover:scale-90 shadow-md hover:shadow-lg" onClick={goToLinkHandler}>
        ...
        <button className=" rounded-xl overflow-hidden transition-all hover:scale-90 shadow-md hover:shadow-lg" onClick={goToLinkHandler}>
          <img src="https://www.thetoyshop.com/medias/2024-tonies-pod-350x350.png?context=bWFzdGVyfHJvb3R8ODY4MDV8aW1hZ2UvcG5nfGFHUTBMMmc0TkM4eE1qSTNPVEkyT1RrME9UUTNNQzh5TURJMExYUnZibWxsY3kxd2IyUXRNelV3ZURNMU1DNXdibWN8OWQ3MzkwYzlhNTkwNzBlMjE4NTMyZjE1NmIyNmEzZGJmNmJiYzIwZWE3NmZhOWM5MGVhODg5ODZiMjE5NGJlOA" alt="Tonies" />
        </button>
        <button className=" rounded-xl overflow-hidden transition-all hover:scale-90 shadow-md hover:shadow-lg" onClick={goToLinkHandler}>
        ...
        <button className=" rounded-xl overflow-hidden transition-all hover:scale-90 shadow-md hover:shadow-lg hidden md:block" onClick={goToLinkHandler}>
