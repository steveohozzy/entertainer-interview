...
const HomeBrands = () => {
  ...
  return (
    <div id="brands" className="flex gap-2 mt-2 py-5">
      ...
      >
        ...
        <button className=" rounded-xl overflow-hidden transition-all hover:scale-90 shadow-md hover:shadow-lg w-1/4 md:w-1/6"
          onClick={() => {
      ...
      >
        ...
        <button className=" rounded-xl overflow-hidden transition-all hover:scale-90 shadow-md hover:shadow-lg hidden md:block w-1/6"
          onClick={() => {
