                ...
                <Swiper
                    ...
                    <SwiperSlide>
                        <div className="flex flex-col flex-wrap bg-white shadow-lg mb-5 rounded-xl h-full">
                            ...
                            <div className="w-full grow flex flex-col justify-between items-center py-1 md:py-3 px-2">
                    ...
                    <SwiperSlide>
                        <div className="flex flex-col flex-wrap bg-white shadow-lg mb-5 rounded-xl h-full">
                            ...
                            <div className="w-full flex grow flex-col justify-between items-center py-1 md:py-3 px-2">
                    ...
                    <SwiperSlide>
                        <div className="flex flex-col flex-wrap bg-white shadow-lg mb-5 rounded-xl h-full">
                            ...
                            <div className="w-full flex flex-col grow justify-between items-center py-1 md:py-3 px-2">
                    ...
                    <SwiperSlide>
                        <div className="flex flex-col flex-wrap items-start bg-white shadow-lg mb-5 rounded-xl h-full">
                            ...
                            <div className="w-full grow flex flex-col justify-between items-stretch py-1 md:py-3 px-2">
