...
const SearchBar = () => {
  ...
  return (
    <div ref={wrapperRef} className="search bg-brandLightBlue pt-6 z-index-2 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <form id="search-form" className="relative">
              <input onFocus={handleFocus} name="search" type="search" placeholder="I'm looking for..." className="relative z-20 outline-0 h-[40px] px-3 rounded-3xl w-full border border-[3px] border-brandBlue font-bold text-textBlue placeholder:text-textBlue" />
              <button className="shadow-md z-20 group text-white font-bold bg-brandRed rounded-full h-[40px] w-[54px] absolute right-0 top-0 transition-all hover:bg-brandGreen hover:scale-105">
            ...
            <div className={`absolute z-10 top-2 left-0 w-full px-4 sm:px-6 lg:px-8 opacity-0 h-0 transition-all overflow-hidden max-h-[calc(100vh-100px)] overflow-y-auto ${showSearchBox && 'opacity-100 h-auto'}`}>
              <div className="w-full bg-white rounded-lg p-4 pt-12 text-brandBlue border-b-[3px] border-red-500 shadow-md mb-4">
                <div className="flex items-start justify-between w-full">
                  <div className="flex flex-col w-full md:w-2/3 max-w-[400px]">
                    ...
                    <div className="flex flex-col space-y-1 mt-2">
                      ...
                      <button className="text textBlue text-sm md:text-base flex items-center justify-between justify-between">
                        <span className="flex items-center">
                          <span className="w-4 md:w-5 h-4 md:h-5 mr-1 block">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                              <g id="Interface / External_Link">
                          ...
                          <span>Outdoor slide</span>
                        </span>
                        <span className="rounded-lg bg-brandGreen px-2 text-white text-[10px] md:text-sm ml-2">
                          <span className="font-bold">NEW TOYS</span> Out this week
                        </span>
                      </button>
                    </div>
                  </div>
