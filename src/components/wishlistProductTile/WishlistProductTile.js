...
const WishlistProductTile = ({product, nocontrols, isMiniCart}) => {
  ...
  return (
    <div className={`flex items-start flex-wrap w-100 py-6 relative after:w-full after:absolute after:bottom-0 after:left-0 after:border-b-[3px] after:lg:w-[50%] last:after:hidden relative`}>
        <div className={`w-[30%] border-[4px] border-brandLightBlue rounded-lg lg:w-[20%]`}>
        ...
        <div className={`w-[70%] lg:w-[80%]`}>
            <div className="flex flex-wrap py-1 h-full">
                <div className={`w-full lg:w-[40%] text-textBlue font-bold px-4 lg:text-lg`}>
                ...
                <div className={`w-full lg:w-[60%] px-4 lg:px-0`}>
                    <div className="flex flex-wrap justify-between items-start">
                        <div className={`flex justify-start text-sm lg:text-base my-2 lg:justify-start w-full lg:w-[20%] lg:flex-col`}>
                            <span className="text-brandRed font-bold">{price}</span>
                            <span className={`line-through text-gray-400 ml-1 lg:ml-0`}>{originalPrice}</span>
                        </div>
                        <div className={`flex justify-between items-start flex-wrap w-full lg:w-[80%] text-gray-500 font-bold`}>
                            ...
                            <div className='text-right mt-3 flex flex-col justify-center h-full w-full lg:w-auto lg:pl-3 lg:mt-0'>
                                ...
                                <button onClick={clearItemHandler} className={`text-brandRed underline text-right text-sm mt-2 lg:absolute bottom-2 right-2`}>remove</button>
                            </div>
                        </div>
                    </div>
                </div>
