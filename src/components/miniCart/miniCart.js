      ...
      >
        <div className="max-h-[calc(100vh-100px)] overflow-y-auto w-full px-3">
          ...
          <div className="w-full text-center mt-4">
            ...
            <div className="bg-brandLightBlue pt-12 pb-4 px-2 rounded-xl mt-[-27px] [&_.swiper-pagination]:relative">
              <Swiper
                ...
                {products.slice(0, 6).map((product) => (
                  <SwiperSlide className="h-auto">
                    ...
                    >
                      ...
                      >
                        <div className="text-xs text-brandBlue font-bold leading-[1.2] xl:leading-[1.1] mb-2 md:mb-0">
                          {product.name}
                        </div>
                        <div>
