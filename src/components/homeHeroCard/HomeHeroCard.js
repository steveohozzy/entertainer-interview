...
const HomeHeroCard = () => {
  ...
  return (
    <div className="h-auto shadow-lg rounded-xl overflow-hidden mt-12 mb-8">
          ...
          <div className="mb-4">
            <h2 className="text-xl lg:text-2xl text-white font-bold text-center">
              <button onClick={goToLinkHandler}>
                Race into Action - Now Half Price
              </button>
            </h2>
          </div>
          <div className="text-white mb-5 text-center">
            <button onClick={goToLinkHandler}>
              Unlelach outdoor fun with this Green Machine Go-Kart offer
            </button>
          </div>
          <Button
