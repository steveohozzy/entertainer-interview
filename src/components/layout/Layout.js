          ...
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <Link
                  to="/account"
                  className="hidden transition-all hover:text-brandLightBlue md:flex items-center ml-4 text-sm group"
                >
              ...
              <div className="flex items-center space-x-4 relative">
                ...
                >
                  ...
                  {isCartOpen && (
                    <span className="absolute bg-white left-[-5px] bottom-[-10px] h-[calc(100%+10px)] w-[60px] rounded-tl-lg rounded-tr-lg">
                      &nbsp;
                    </span>
                  )}
                </button>
