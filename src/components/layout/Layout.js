                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <Navigation />
                            <a href="/account" className="hidden transition-all hover:text-brandLightBlue md:flex items-center ml-4 text-sm group">
                        ...
                        <div className="flex items-center space-x-4 relative">
                            ...
                            <button onClick={toggleIsCartOpen} name="View cart" className="flex items-center  text-white group">
                                <span className={`transition-all group-hover:rotate-[25deg] relative z-20 ${isCartOpen ? 'text-brandBlue' : 'text-white'}`}>
                                ...
                                <div className="ml-1 text-xs bg-brandRed w-[24px] h-[24px] flex items-center justify-center rounded-full relarive z-20">{cartCount}</div>
                                <span className="sr-only">View your cart</span>
                                <span className="text-sm ml-2 hidden md:block">£{cartTotal.toFixed(2)}</span>
                                {isCartOpen &&
                                    <span className="absolute bg-white left-[-5px] bottom-[-10px] h-[calc(100%+10px)] w-[60px] rounded-tl-lg rounded-tr-lg">&nbsp;</span>
                                }
                            </button>
                            <MiniCart />
