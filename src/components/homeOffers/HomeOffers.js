    ...
    <div>
      ...
      >
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">              
              <img alt="2 for £15" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-2-for-15-350x90.jpg?context=bWFzdGVyfHJvb3R8Mzg2OTB8aW1hZ2UvanBlZ3xhRFV3TDJnelppOHhNalUyTWpBeE1qQTNPREV4TUM4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFRJdFptOXlMY0tqTVRVdE16VXdlRGt3TG1wd1p3fGUzMTU5YjE3MzI5ZmE4Y2IxNWMxNTFiM2I4Yzk0MmRhNDNmOGI1NGI1OTg2YmRjOGI2NDljODNiOWNhNTI5ZjM" title="2 for £15" />
        ...
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">              
              <img alt="3 for 2" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-3-for-2-350x90.jpg?context=bWFzdGVyfHJvb3R8MzcxNTd8aW1hZ2UvanBlZ3xhR0ppTDJnNFlTOHhNalUyTWpBeE1UazBOekF6T0M4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFRNdFptOXlMVEl0TXpVd2VEa3dMbXB3Wnd8YTdmZDdiZTlkODAzM2RlY2UyYjZiMThlYTU3OGJjNDJkZmFkZDIwNzMzMWVjMDliM2E5ZTI5ZGI3MGMxYzU2OQ" title="3 or 2" />
        ...
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">				 
              <img alt="Buy One Get One Half Price" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-bogshp-350x90.jpg?context=bWFzdGVyfHJvb3R8NDI4MDF8aW1hZ2UvanBlZ3xhRGd3TDJnek9DOHhNalUyTWpBeE1qSTNORGN4T0M4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFdKdlozTm9jQzB6TlRCNE9UQXVhbkJufDIwMzNhODMyMTkyNmIzMjRiMWU5Zjc3OTg5ZDE0OWRjMzYzYjJlNTg2MjVlNWYyNmVhN2M3MzViNzU3ZWNmZGM" title="Buy One Get One Half Price" />
        ...
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">				 			 						 
              <img alt="2 for £20" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-2-for-20-350x90.jpg?context=bWFzdGVyfHJvb3R8MzkxNjF8aW1hZ2UvanBlZ3xhR0k1TDJnNFpDOHhNalUyTWpBeE1UZzRNVFV3TWk4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFRJdFptOXlMY0tqTWpBdE16VXdlRGt3TG1wd1p3fDU2NDlkMWZiMTMwYmY3OTRkZTJiMzg3MTBlYjJmZGIxMDU3NTJiNzY0ZmJiYWY0NzM5ZTg5YzM3ZDM2MDFmZTc" title="2 for £20" />
        ...
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">				 			 						 				 
              <img alt="Incredible Deals" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-incredible-deals-350x90.jpg?context=bWFzdGVyfHJvb3R8NDQxNjJ8aW1hZ2UvanBlZ3xhREV5TDJnNFlpOHhNalUyTWpBeE1Ua3hOREkzTUM4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFdsdVkzSmxaR2xpYkdVdFpHVmhiSE10TXpVd2VEa3dMbXB3Wnd8NDNkZDdmOWJkMWZiOGZhZWI1ZGExOGI1Njk0OThhZDFkMzFhYzYwY2UwZTQwMjMxYjI4M2UyYzAwNzc5NjVmMw" title="Incredible Deals" />
        ...
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">				 			 						 				 							 
              <img alt="Buy 1 Get 2nd Half Price" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-bogshp-350x90.jpg?context=bWFzdGVyfHJvb3R8NDI4MDF8aW1hZ2UvanBlZ3xhRGd3TDJnek9DOHhNalUyTWpBeE1qSTNORGN4T0M4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFdKdlozTm9jQzB6TlRCNE9UQXVhbkJufDIwMzNhODMyMTkyNmIzMjRiMWU5Zjc3OTg5ZDE0OWRjMzYzYjJlNTg2MjVlNWYyNmVhN2M3MzViNzU3ZWNmZGM" title="Buy 1 Get 2nd Half Price" />
        ...
        <SwiperSlide className="h-auto">
          <div className="transition-all hover:scale-105 py-2">
            <Link to="/category" className="block rounded-3xl md:rounded-[40px] lg:rounded-[50px] overflow-hidden">		 
              <img alt="Buy 1 get 1 Free on Kweenies" class="offer-title" src="https://www.thetoyshop.com/medias/2025-promo-title-bogof-350x90.jpg?context=bWFzdGVyfHJvb3R8NDE5MDd8aW1hZ2UvanBlZ3xhRE5tTDJnell5OHhNalUyTWpBeE1qRTBNelkwTmk4eU1ESTFMWEJ5YjIxdkxYUnBkR3hsTFdKdloyOW1MVE0xTUhnNU1DNXFjR2N8MTc2YTQxMWI1Njc0ZDgxZTQwMzdmMDkyMzY5YmJlZjAwMDUyZjkzZTk2N2VjZGQ3NGI3YWI3ZmNiNmM2ZDljOA" title="Buy 1 get 1 Free on Kweenies" />
