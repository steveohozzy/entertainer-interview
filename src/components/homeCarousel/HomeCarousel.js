        ...
        <div className="rounded-xl bg-yellow-300 flex flex-wrap flex-row-reverse md:flex-row h-full">
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
            <div className="mb-5 hidden md:block">
              ...
              <Button 
                    className='shadow-md hover:shadow-lg group inline-flex items-center justify-center font-bold text-lg rounded-[30px] bg-brandGreen text-white py-2 px-4 pl-2 transition-all hover:bg-textBlue hover:scale-105'
                    iconpath={
