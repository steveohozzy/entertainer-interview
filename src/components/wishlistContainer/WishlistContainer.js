      ...
      <div className="border-[3px] border-brandRed p-3 md:p-5 rounded-xl">
        ...
        <div className="flex gap-4 justify-center">
          <div className="w-2/3 md:w-1/2">
            ...
            <button className="transition-all border-[3px] border-brandRed rounded-full w-10 h-10 md:w-12 md:h-12 p-1 md:p-2 flex items-center justify-center hover:rotate-[45deg]">
              <span className="flex items-center w-9 h-9 text-brandRed">
