    ...
    <>
        ...
        <div className="flex gap-6 w-full md:w-1/2 items-start">
          ...
          <div className="w-1/2 md:w-2/3">
            ...
            <div className="text-textBlue text-xs md:text-base">
              ...
              <Button
                className="shadow-md hover:shadow-lg w-full group inline-flex items-center justify-center font-bold text-sm md:text-lg rounded-[30px] bg-brandGreen text-white py-2 px-4 pl-2 transition-all hover:bg-brandLightGreen hover:scale-105 mt-3 md:max-w-[90%]"
                iconpath={
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="flex gap-3 md:gap-6 w-full items-start">
          ...
          <div className="w-1/3">
            <Button
              className="shadow-md hover:shadow-lg w-full group inline-flex items-center justify-center font-bold text-sm md:text-lg rounded-[30px] bg-brandGreen text-white py-2 px-4 pl-2 transition-all hover:bg-brandLightGreen hover:scale-105 mt-3 "
              iconpath={
