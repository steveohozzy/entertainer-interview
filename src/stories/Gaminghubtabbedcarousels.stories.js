...
import { GamingHubTabbedCarousels } from './Gaminghubtabbedcarousels';
import { useArgs } from 'storybook/preview-api';

export default {
  title: 'Gaming Hub/Tabbed Carousels',
  component: GamingHubTabbedCarousels,
  parameters: {
    layout: 'fullscreen',
  },
  argTypes: {
...
export const GamingHubTabbedCarouselsSection = {
  args: {
    user: 'stories',
  ...
  render: function Render(args) {
    ...
    // -------------------------------------------------------
    // LOAD FROM FIREBASE (USER COLLECTION → GamingHubTabbedCarousels DOC)
    // -------------------------------------------------------
    useEffect(() => {
      const load = async () => {
        ...
        try {
          const docRef = doc(db, args.user, "GamingHubTabbedCarousels");
    ...
    useEffect(() => {
      ...
      const send = async () => {
        try {
          const docRef = doc(db, selectedUser, "GamingHubTabbedCarousels");
    ...
    return <GamingHubTabbedCarousels {...args} />;
  },
};