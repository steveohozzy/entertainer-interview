...
import "./kidultroundal.css";

/** Primary UI component for user interaction */
export const KidultTab4 = ({
  roundal1image,
  roundal1alt,
  roundal1link,
  roundal1background,
     ...
     <>
      <div class="roundal">
        <a href={roundal1link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal1background}}>
      ...
      {roundal3image && 
        ...
        <a href={roundal3link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal3background}}>
      ...
      {roundal4image && 
        ...
        <a href={roundal4link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal4background}}>
      ...
      {roundal5image && 
        ...
        <a href={roundal5link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal5background}}>
      ...
      {roundal6image && 
        ...
        <a href={roundal6link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal6background}}>
      ...
      {roundal7image && 
        ...
        <a href={roundal7link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal7background}}>
      ...
      {roundal8image && 
        ...
        <a href={roundal8link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal8background}}>
      ...
      {roundal9image && 
        ...
        <a href={roundal9link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal9background}}>
      ...
      {roundal10image && 
        ...
        <a href={roundal10link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal10background}}>
      ...
      {roundal11image && 
        ...
        <a href={roundal11link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal11background}}>
      ...
      {roundal13image && 
        ...
        <a href={roundal13link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal13background}}>
      ...
      {roundal14image && 
        ...
        <a href={roundal14link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal14background}}>
      ...
      {roundal15image && 
        ...
        <a href={roundal15link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal15background}}>
      ...
      {roundal16image && 
        ...
        <a href={roundal16link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal16background}}>
      ...
      {roundal18image && 
        ...
        <a href={roundal18link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal18background}}>
      ...
      {roundal19image && 
        ...
        <a href={roundal19link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal19background}}>
      ...
      {roundal20image && 
        ...
        <a href={roundal20link} class="outer-link">
          <div class="roundal-image" style={{'--kidultroundal1bg': roundal20background}}>
