...
.media-module-banner-content {
    ...
    justify-content: center;
      ...
      <div class="media-module-banner-wrapper">
      <a
    href={link}
...
>
      ...
      {video && video !== ' ' &&
        ...
        {buttontext && (
        <div class="media-module-banner-content">
            <div class="cta-button"
                ...
                <button
                    ...
                    style={{
                        "--primary-cta-button-bg-color": buttonbackgroundcolor,
                        "--primary-cta-button-hover-bg-color": buttonhoverbackgroundcolor,
                        ...
                        "--primary-cta-button-hover-border-color": buttonborderhovercolor,
                    }}
                                >
