...
const previousModule = useRef('');
  ...
  const deleteSelectedModule = async () => {
    ...
    try {
      ...
      setModules(prev =>
        prev.filter(module => module !== selectedModule)
      );
...
panel1image: 'https://www.thetoyshop.com/medias/300Wx300H-580440-Primary?context=bWFzdGVyfGltYWdlc3w3Mzg5N3xpbWFnZS9qcGVnfGFHVTNMMmd6T0M4eE1qWXhPRFkxTnpVNU5UUXlNaTh6TURCWGVETXdNRWhmTlRnd05EUXd1Y2xBdmYxY1dGMWFYSmhiM2c2YVdKc1pXNXp8YzFlZWNjZTRmZGNkNWNhMzE5MDNmOWE4YTczNzM3OWY5ODM0OTIwNTQ3N2Y0MGZkYjA1MWVhYWY2ZGE5NWQ2',
