    ...
    <>
      <style>
        {`
            ...
            .store-push-banner .media {
                aspect-ratio: 335/188;
                border-radius: 8px;
                overflow: hidden;
            }

            .store-push-banner .media img,
            .store-push-banner .media iframe,
            .store-push-banner .media video {
                object-fit: cover;
                width: 100%;
                height: 100%;
                position: relative;
            ...
            .store-push-banner .hero-tile-info {
                display: flex;
                flex-direction: column;
                align-items: center;
            ...
            .store-push-banner .hero-tile-info .brand-logo {
                position: absolute;
                top: -32px;
                height: 40px;
                z-index: 2;
            ...
            .store-push-banner .hero-tile-info .brand-logo img,
            .store-push-banner .hero-tile-info .brand-logo svg {
                height: 100%;
                width: auto;
            }

            .store-push-banner .hero-tile-info h3 {
                font-size: 20px;
            ...
            .store-push-banner .hero-tile-info .hero-blurb {
                color: background,
                font-size: 14px;
                font-weight: 200;
            }

            .store-push-banner .hero-logo {
                width: auto;
                max-height: 80px;
                max-width: 100%;
            }
            ...
            @media (min-width: 768px) {
                ...
                .store-push-banner.is-flipped .hero-tile-info {
                    margin-right: 0px;
                    margin-left: -20px;
                ...
                .store-push-banner .hero-tile-info h2 {
                    font-size: 24px;
                    margin: 0;
                }
      ...
      <div class="store-push-banner-container">
        <a href="https://www.thetoyshop.com/search?text=LEGO%20Batman%20Legacy%20of%20The%20Dark%20Knight" class={`store-push-banner ${flipped ? 'is-flipped' : ''}`}>
          <div class="media">
          ...
          <div class="hero-tile-info">
              ...
              <div class="cta-button"
                ...
                <button
                    ...
                    style={{
                        "--primary-cta-button-bg-color": buttonBgColor,
                        "--primary-cta-button-hover-bg-color": buttonHoverBgColor,
                        "--primary-cta-button-text-color": buttonTextColor,
                        "--primary-cta-button-hover-text-color": buttonHoverTextColor,
                        "--primary-cta-button-border-color": buttonBorderColor,
                        "--primary-cta-button-hover-border-color": buttonHoverBorderColor,
                    }}
                                >
                    <span class="swoosh-container"
                            ...
                            >{buttontext}<span class="cta-icon"
                                >{buttonIcons[ctaIcon]}</span
                            ><span class="star-end"
                                ><svg
                                width="11"
                                height="11"
