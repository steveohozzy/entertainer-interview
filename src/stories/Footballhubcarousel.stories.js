...
import { Footballhubcarousel } from './Footballhubcarousel';
import { useArgs } from 'storybook/preview-api';

export default {
  title: 'Football Hub/Flickety Carousel',
  component: Footballhubcarousel,
  parameters: {
    layout: 'fullscreen',
  },
  argTypes: {
...
export const FootballhubcarouselContent = {
  args: {
    user: 'stories',
  ...
  render: function Render(args) {
    ...
    // -------------------------------------------------------
    // LOAD FROM FIREBASE (USER COLLECTION → Footballhubcarousel DOC)
    // -------------------------------------------------------
    useEffect(() => {
      const load = async () => {
        ...
        try {
          const docRef = doc(db, args.user, "Footballhubcarousel");
    ...
    useEffect(() => {
      ...
      const send = async () => {
        try {
          const docRef = doc(db, selectedUser, "Footballhubcarousel");
    ...
    return <Footballhubcarousel {...args} />;
  },
};