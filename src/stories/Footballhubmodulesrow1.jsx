...
export const FootballHubModulesRow1 = ({
  panel1video,
  panel1image,
  panel1imagealt,
  panel1title,
...
.video-hub-container .media video {
  top: 0;
  left: 0;
  width: 100%;
  object-fit: cover;
}
  .video-hub-container-info {
    width: 100%;
    display: flex;
    flex-direction: row;
    align-items: center;
  ...
  .video-hub-container-info .video-title {
    font-size: 18px;
  ...
  .video-hub-container-info .hero-button {
    display: inline-flex;
    align-items: center;
  ...
  .video-hub-container-info .hero-button:hover {
  ...
  .video-hub-container-info .hero-button .basket-icon {
    transition: all 0.3s;
    transform: rotate(15deg);
    margin-left: 5px;
  }

  .video-hub-container-info .hero-button:hover .basket-icon {
    transform: rotate(-10deg);
  }

  .video-hub-container-info .hero-button .star-start {
    position: relative;
    top: -3px;
  }

  .video-hub-container-info .hero-button .swoosh-container {
    display: flex;
    align-items: center;
    justify-content: end;
    margin-right: 5px;
  ...
  .video-hub-container-info .hero-button .swoosh {
    display: block;
    width: 0;
    height: 3px;
    margin-top: -3px;
  ...
  .video-hub-container-info .hero-button:hover .swoosh {
    width: 7px;
  }

  .video-hub-container-info .hero-button .star-end {
    position: relative;
    bottom: -5px;
    transition: all 0.3s;
  }

  .video-hub-container-info .hero-button:hover .star-end {
    scale: 1.1;
...
.blog-container .media img {
  ...
  .blog-container-info .blog-title {
    font-size: 18px;
    font-family: "Nunito Bold", "Tahoma Bold", sans-serif;
    color: #1f2b91;
    margin: 20px 0;
  ...
  .blog-container-info .hero-button {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    border-radius: 50px;
  ...
  .blog-container-info .hero-button:hover {
    background-color: #1f2b91;
    scale: 1.05;
    box-shadow: 0 0 18px rgba(3, 33, 33, 0.3);
    color: #fff;
  ...
  .blog-container-info .hero-button .basket-icon {
    transition: all 0.3s;
    transform: rotate(15deg);
    margin-left: 5px;
  }

  .blog-container-info .hero-button:hover .basket-icon {
    transform: rotate(-10deg);
  }

  .blog-container-info .hero-button .star-start {
    position: relative;
    top: -3px;
  }

  .blog-container-info .hero-button .swoosh-container {
    display: flex;
    align-items: center;
    justify-content: end;
    margin-right: 5px;
  ...
  .blog-container-info .hero-button .swoosh {
    display: block;
    width: 0;
    height: 3px;
    margin-top: -3px;
  ...
  .blog-container-info .hero-button:hover .swoosh {
    width: 7px;
  }

  .blog-container-info .hero-button .star-end {
    position: relative;
    bottom: -5px;
    transition: all 0.3s;
  }

  .blog-container-info .hero-button:hover .star-end {
    scale: 1.1;
    transform: rotate(30deg);
  }
        `}
      ...
      <div class="story-modules">
        <a href={panel1link} class="video-hub-container">
          <div class="media">
          ...
          <div class="video-hub-container-info">
            <div class="video-title">{panel1title}</div>
            <button href={panel1link} class="hero-button">
        ...
        <div class="blog-container-info">
          <div class="blog-title">{panel2title}</div>
          <button href={panel2link} class="hero-button">
            <span class="swoosh-container"><span class="star-start"><svg width="11" height="11" viewBox="0 0 11 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4.23539 2.16758C4.31585 1.75612 4.83196 1.6292 5.09362 1.92958L6.64272 3.65653L8.92869 3.36308C9.33686 3.31475 9.62105 3.7548 9.41431 4.12022L8.26344 6.1095L9.24532 8.18833C9.41411 8.56311 9.07604 8.98116 8.67962 8.89652L6.43413 8.40043L4.74982 9.98635C4.45362 10.2631 3.94852 10.0788 3.90018 9.67067L3.67114 7.38306L1.6601 6.27065C1.29468 6.06391 1.31163 5.54034 1.6864 5.37155L3.81205 4.44154L4.23539 2.16758Z" fill-opacity="0.5"></path></svg></span><span class="swoosh">&nbsp;</span></span>{panel2buttontext}<span class="basket-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16" fill="none">
...
FootballHubModulesRow1.propTypes = {
