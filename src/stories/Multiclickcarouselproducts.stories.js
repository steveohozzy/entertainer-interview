...
import { MulticlickCarouselProductFeed} from './Multiclickcarouselproducts';
import { useArgs } from 'storybook/preview-api';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
export default {
  title: 'Components/Multiclick Carousel Product Feed',
  component: MulticlickCarouselProductFeed,
  parameters: {
...
export const MulticlickCarouselProducts = {
  args: {
    user: 'stories',
    categoryurl: '',
    maxItems: 12,
