...
<style>{`
  ...
  .promotional-banner .hero-button {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    border-radius: 50px;
    background-color: var(--button-bg,#009e44);
  ...
  .promotional-banner .hero-button:hover {
    background-color: var(--button-hover-bg,#afcb17);
    scale: 1.05;
  ...
  .promotional-banner .hero-button .basket-icon {
    transition: all 0.3s;
    transform: rotate(15deg);
    margin-left: 5px;
  }

  .promotional-banner .hero-button:hover .basket-icon {
    transform: rotate(-10deg);
  }

  .promotional-banner .hero-button .star-start {
    position: relative;
    top: -3px;
  }

  .promotional-banner .hero-button .swoosh-container {
    display: flex;
    align-items: center;
    justify-content: end;
    margin-right: 5px;
  ...
  .promotional-banner .hero-button .swoosh {
    display: block;
    width: 0;
    height: 3px;
    margin-top: -3px;
  ...
  .promotional-banner .hero-button:hover .swoosh {
    width: 7px;
  }

  .promotional-banner .hero-button .star-end {
    position: relative;
    bottom: -5px;
    transition: all 0.3s;
  }

  .promotional-banner .hero-button:hover .star-end {
    scale: 1.1;
    transform: rotate(30deg);
  }

  .promotional-banner .sign-up-title {
    font-size: 14px;
    margin: 10px;
  }
  ...
  ${signupborderhovercolor ? `
    .promotional-banner:hover {
      border-color: ${signupborderhovercolor};
    }
  ` : ""}
...
<div class="promotional-banner">
  <img src={signupimage} alt={signupimagealt} class="banner-image" />
  <div class="banner-text">
    ...
    <a href={signuplink} class="hero-button"
          style={{
            "--button-bg": signupbuttonbackgroundcolor,
            "--button-hover-bg": signupbuttonhoverbackgroundcolor,
            "--button-text": signupbuttontextcolor,
            "--button-hover-text": signupbuttontexthovercolor,
            "--button-border-color": signupbuttonbordercolor,
            "--button-hover-border-color": signupbuttonhoverbordercolor
          }}
        >
          <span class="swoosh-container"><span class="star-start"><svg width="11" height="11" viewBox="0 0 11 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="basket-icon">
                  {buttonIcons[signupbuttonIcon] || buttonIcons.shop}
                </span>
...
signupimagealt:PropTypes.string,
...
signupborderhovercolor:PropTypes.string,
};