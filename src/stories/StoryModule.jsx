...
.story-module .media video,
.story-module .media img{
width:100%;
height:100%;
object-fit:cover;
display:block;
...
.story-module:hover .story-title{
...
<div class="story-modules">
  {panel1link && 
    <a href={panel1link} class="story-module"
      style={{
        "--panel-border-color": panel1bordercolor,
        "--panel-border-hover-color": panel1borderhovercolor,
      }}
    >
      <div class="media">
      ...
      <div class="story-module-info">
        <div class="story-title" style={{
          "--panel-text-color": panel1textcolor,
          "--panel-hover-color": panel1texthovercolor,
        }}>{panel1title}</div>
        <button href={panel1link} class="hero-button"
          style={{
            "--button-bg": panel1buttonbackgroundcolor,
            "--button-hover-bg": panel1buttonhoverbackgroundcolor,
            "--button-text": panel1buttontextcolor,
            "--button-hover-text": panel1buttontexthovercolor,
            "--button-border-color": panel1buttonbordercolor,
            "--button-hover-border-color": panel1buttonhoverbordercolor
          }}
        >
  ...
  {panel2link && 
    <a href={panel2link} class="story-module"
      style={{
        "--panel-border-color": panel2bordercolor,
        "--panel-border-hover-color": panel2borderhovercolor,
      }}
    >
      <div class="media">
      ...
      <div class="story-module-info">
        <div class="story-title" style={{
          "--panel-text-color": panel2textcolor,
          "--panel-hover-color": panel2texthovercolor,
        }}>{panel2title}</div>
        <button href={panel2link} class="hero-button"
          style={{
            "--button-bg": panel2buttonbackgroundcolor,
            "--button-hover-bg": panel2buttonhoverbackgroundcolor,
            "--button-text": panel2buttontextcolor,
            "--button-hover-text": panel2buttontexthovercolor,
            "--button-border-color": panel2buttonbordercolor,
            "--button-hover-border-color": panel2buttonhoverbordercolor
          }}
        >
          <span class="swoosh-container"><span class="star-start"><svg width="11" height="11" viewBox="0 0 11 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
