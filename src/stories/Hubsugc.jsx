...
export const Hubsugc= ({
  ...
  const ugcpanels = [
  {
    ...
    alt: panel1imagealt,
    link: panel1link,
    linktext: panel1linktext,
  linkicon: panel1linkicon,
  },
  {
    image: panel2image,
    alt: panel2imagealt,
    ...
    {validugcpanels.map((panel, index) => (
      <div class="carousel-cell">
        ...
        >
          ...
          {panel.link && panel.linktext &&
            <div class="cta-button">
          <a
              href={panel.link}
              class="hero-button"
              style={{
                "--panel-button-bg": panel.buttonbackgroundcolor,
                "--panel-button-hover-bg": panel.buttonhoverbackgroundcolor,
                "--panel-button-text": panel.buttontextcolor,
                "--panel-button-hover-text": panel.buttonhovercolor,
            ...
            >
              <span class="swoosh-container"
                      ...
                      >{panel.linktext}<span class="basket-icon"
                        >{buttonIcons[panel.linkicon] || buttonIcons.basket}</span
                      ><span class="star-end"
                        ><svg
                          width="11"
                          height="11"
...
<script>
  ...
  var carousel = document.querySelector(".hubs-ugc-content .carousel");
