...
--countdown-label-color: #444444;
  ...
  <script
    dangerouslySetInnerHTML={{
      __html: `
        (function () {
          var module = document.getElementById("countdown-module");

          if (!module) {
            return;
          }

          var targetDate = module.getAttribute("data-target-date");
          var targetTime = module.getAttribute("data-target-time");

          if (!targetDate || !targetTime) {
            return;
          }

          var countdownNumbers = module.querySelectorAll(".countdown-number");
          var countdownExpired = module.querySelector(".countdown-expired");
          var countdownWrapper = module.querySelector(".countdown-wrapper");

          function updateCountdown() {
            var target;

            if (!isNaN(targetDate) && targetDate !== "") {
              var d = new Date(parseInt(targetDate, 10));
            ...
            if (difference <= 0) {
              ...
              if (countdownExpired) {
                countdownExpired.style.display = "block";
              }
