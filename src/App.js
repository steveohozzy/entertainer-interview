        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button name="View cart" className="flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        ...
        {visibleFilteredProducts.length < filteredProducts.length && (
          <div className="text-center mt-12">
            <button name="Load more products" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm border border-input bg-background hover:bg-gray-100 h-11 rounded-md px-8 transition-all hover:scale-105 hover:shadow-md" onClick={loadMoreProducts}>
